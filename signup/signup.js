...
if (!signupForm) {
    ...
    signupForm.addEventListener('submit', function (e) { return __awaiter(_this, void 0, void 0, function () {
        var Username, Useremail, Userpassword, UserconfirmPassword, response, data, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    UserconfirmPassword = document.getElementById("UserconfirmPassword").value;
                ...
                case 1:
                    ...
                    return [4 /*yield*/, fetch("http://localhost:4000/users/signup", {
                            method: "POST",
                ...
                case 4:
                    ...
                    console.error("SIGNUP ERR:", error_1.message);
